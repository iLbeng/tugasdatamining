...
else if ($_GET['module']=='semuadata'){
	include "semua-data.php";
}
else if ($_GET['module']=='prosesexcel'){
	include "proses_excel.php";
}
else if ($_GET['module']=='perhitungan'){
	include "perhitungan.php";
}
else if ($_GET['module']=='datamining'){
	include "mining.php";
}
else if ($_GET['module']=='pohonkeputusan'){
	include "pohon-keputusan.php";
}
else if ($_GET['module']=='hapuspohon'){
...
else if ($_GET['module']=='installdata'){
...
else if ($_GET['module']=='inputmerek'){
...
else if ($_GET['module']=='inputtahun'){
...
else if ($_GET['module']=='simpanatribut'){
	if (empty($_POST[b])){
...
else if ($_GET['module']=='inputdataa'){
...
else if ($_GET['module']=='inputdataaa'){
